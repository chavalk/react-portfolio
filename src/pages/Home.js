        ...
        <div className="container" id="container-home">
            <div className="row">
                <div className="col-md-4">
                    <img src="https://www.josesgarcia.com/images/profile.jpeg" class="img-fluid rounded shadow-lg" alt="Profile"></img>
                </div>
                <div className="col-md-8">
                    ...
                    <p className="p-home ml-4"><h4>Some of the languages and technologies I use are:</h4> React.js, MongoDB, Node.js, Express.js, Git, JavaScript, MySQL, Bootstrap, jQuery, Ajax, APIs, Object Oriented Programming, Linting and Continuous Integration, Progressive Web Apps, Web Optimization, Object Relational Mapping, Handlebars, HTML5, and CSS3.</p>
